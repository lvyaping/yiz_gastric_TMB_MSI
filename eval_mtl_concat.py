...
if args.task == 'dummy_mtl_concat':
    args.n_classes=2
    dataset = Generic_MIL_MTL_Dataset(csv_path = 'dataset_csv/test_6cli_50.csv',
                            data_dir= '/home/lvyp/yizhong_project/RESULTS_DIRECTORY',
                            shuffle = False, 
                            print_info = True,
                            label_dicts = [{'MSS':0,  'MSI':1},
                                            {'TMB_L':0,  'TMB_H':1}
                                            ],
...
if __name__ == "__main__":
    ...
    df_dict = {'folds': folds, 'cls_test_auc': all_cls_auc, 'cls_test_acc': all_cls_acc, 'site_test_auc': all_site_auc, 'site_test_acc': all_site_acc}
